...
st.markdown("""
    ...
    /* Product Grid Styling (Exact match to image) */
    .product-grid {
        display: grid;
...
# ==========================================
# FULL PRODUCT FAMILY GRID SECTION (NEW FEATURE BEFORE FOOTER)
# ==========================================
st.markdown("---")
st.markdown("<h2 style='text-align: center; font-weight: 700; color: #1E293B; margin-top: 2rem;'>Meet our full product family</h2>", unsafe_allow_html=True)
